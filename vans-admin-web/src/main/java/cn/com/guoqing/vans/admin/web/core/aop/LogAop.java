...
import cn.com.guoqing.vans.admin.web.common.annotion.BussinessLog;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(cn.com.guoqing.vans.admin.web.common.annotion.BussinessLog)")
...
//        }
        ...
        LogManager.me().executeLog(LogTaskFactory.bussinessLog(user.getId(), bussinessName, className, methodName, null));
    }
}